...
<path d="M509.506 1322.55H1069.6L509.506 762.453V1322.55Z" fill="blue"/>
            ...
            <div class="social-icons-icon">
        <a href="https://foundation.app/@nanaschlez" style="background: blue; width: 24px; height:24px;display:block;">
...
h1 {
  ...
  transform: translate3d(36.042689784px, 25.2373631725px, 0) ;
  z-index: 9999;
